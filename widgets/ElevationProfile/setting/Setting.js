...
define([
  ...
  function (declare, lang, array, html, on, query, _WidgetsInTemplateMixin, BaseWidgetSetting, units, LinearUnit, Color,
    Chart, Grid, Areas, MouseIndicator, TouchIndicator, ThreeD, esriSniff, Deferred, Measurement, SymbologyEdit,
    ChartEdit, WKIDEdit, number, Popup, keys) {
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      _bindEvents: function () {
        ...
        this.own(on(this.btnWKID, 'click', lang.hitch(this, function () {
          this._openWKIDEdit(this.nls.editWKID);
        })));
      ...
      _onWKIDEditOk: function () {
        var newConfig = this.wkidedit.getConfig();
        this.config.wkid = newConfig.wkid;
        this.popup3.close();
        this.popupState = '';
      },

      _onWKIDEditClose: function () {
        this.wkidedit = null;
        this.popup3 = null;
      },

      _openWKIDEdit: function (title){
        this.wkidedit = new WKIDEdit({
          nls: this.nls,
          config: this.config || {},
          widget:  this
        });
        ...
        this.popup3 = new Popup({
          ...
          width: 740,
          autoHeight: true,
          content: this.wkidedit,
          container: 'main-page',
          buttons: [{
            label: this.nls.ok,
            key: keys.ENTER,
            onClick: lang.hitch(this, '_onWKIDEditOk')
          }, {
            label: this.nls.cancel,
            key: keys.ESCAPE
          }],
          onClose: lang.hitch(this, '_onWKIDEditClose')
        });
        html.addClass(this.popup3.domNode, 'widget-setting-wkid');
        this.wkidedit.startup();
      },
