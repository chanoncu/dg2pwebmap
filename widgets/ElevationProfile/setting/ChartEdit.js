  ...
  function(
    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      setConfig:function(config){
        ...
        this.elevDecimalPlaces.setValue(this.config.chartRenderingOptions.elevationTipDecimalPlaces);
      ...
      getConfig: function() {
        ...
        this.config.chartRenderingOptions.elevationTipDecimalPlaces = this.elevDecimalPlaces.get('value');
