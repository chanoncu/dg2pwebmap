...
define([
  ...
  function (declare, BaseWidget, Evented, _OnDijitClickMixin, _WidgetsInTemplateMixin,
    ...
    put, domClass, Color, Chart, Grid, Areas, MouseIndicator, TouchIndicator, ThreeD, esriSniff,
    ...
    Measurement, html, ProgressBar, TabContainer, Message,
    ...
    return declare([BaseWidget, _OnDijitClickMixin, _WidgetsInTemplateMixin, Evented], {
      ...
      _createProfileChart: function (elevationInfo) {
        ...
        var outWKIDstr = this.config.wkid || '102100';
        var outSpatialReference = new SpatialReference(parseInt(outWKIDstr, 10));
        var projectedGeometries;
        projection.load().then(lang.hitch(this, function() {
          if(this.elevationInfo){
            projectedGeometries = projection.project(this.elevationInfo.geometry, outSpatialReference);
            this.elevationInfo.geometry = projectedGeometries;
          }
        }));
